...
const usesPageSidebar = computed(() =>
  ['hermes.chat', 'hermes.session', 'hermes.connections', 'hermes.experts', 'hermes.history', 'hermes.historySession', 'hermes.globalAgent', 'hermes.globalAgentSession', 'hermes.groupChat', 'hermes.groupChatRoom', 'hermes.workflow'].includes(route.name as string),
)
