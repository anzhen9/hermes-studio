...
mcuFirmwareRoutes.get('/api/hermes/mcu/sparkbot/firmware/:version/manifest', ctrl.sparkbotManifest)
mcuFirmwareRoutes.get('/api/hermes/mcu/sparkbot/firmware/:version/firmware.bin', ctrl.sparkbotDownload)

// Keep legacy SparkBot routes for already-deployed devices.
mcuFirmwareRoutes.get('/api/hermes/mcu/sparkbot/firmware/manifest', ctrl.sparkbotLegacyManifest)
mcuFirmwareRoutes.get('/api/hermes/mcu/sparkbot/firmware.bin', ctrl.sparkbotLegacyDownload)
