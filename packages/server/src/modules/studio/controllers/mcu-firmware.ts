...
const TARGETS: Record<FirmwareTarget, TargetConfig> = {
  c3: {
    ...
    legacyRoute: '/api/studio/mcu/firmware.bin',
    versionedRoute: (version) => `/api/studio/mcu/firmware/${version}/firmware.bin`,
    distPathByVersion: {
  ...
  sparkbot: {
    ...
    legacyRoute: '/api/studio/mcu/sparkbot/firmware.bin',
    versionedRoute: (version) => `/api/studio/mcu/sparkbot/firmware/${version}/firmware.bin`,
    distPathByVersion: {
